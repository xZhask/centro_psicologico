        ...
        try {
            ...
            $pdo->prepare(
                "INSERT INTO paciente_paquetes
                     (paquete_id, paciente_id, profesional_id, atencion_id, sesiones_restantes,
...
class PacientePaquete {
    ...
    public static function desvincular(int $id): void {
        Database::query(
            "UPDATE paciente_paquetes SET atencion_id = NULL WHERE id = ?",
            [$id]
        );
    }
